...
export default function Register() {
  ...
  const handleSocialLogin = async (provider: "google" | "apple") => {
    ...
    if (result.error) {
      toast({ title: "Sign up failed", description: String(result.error), variant: "destructive" });
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 bg-hero-gradient items-center justify-center p-12">
        <div className="text-center text-primary-foreground max-w-md space-y-6">
          ...
          <h1 className="text-4xl font-display font-bold">Join DigiStudentPro</h1>
          <p className="text-lg opacity-90">
            Start your journey with Kenya's CBC digital learning ecosystem.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-sm space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">Get started with DigiStudentPro</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" placeholder="Your full name" className="pl-9" value={fullName} onChange={(e) => setFullName(e.target.value)} required />
              </div>
            </div>
            <div className="space-y-2">
